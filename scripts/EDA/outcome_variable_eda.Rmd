...
**Overall**, < 0.3% of the ABCD cohort ever meets Tier 1, < 0.15% meets Tier 2, and Tier 3/Tier 4 occur in only one or two dozen participants each wave. Persistence across multiple waves is exceptionally rare (no one meets Tier 3 or Tier 4 at two consecutive waves). These findings reinforce that even with additional “validation” criteria, bipolar-spectrum indicators in ABCD are infrequent and highly unstable over time.
