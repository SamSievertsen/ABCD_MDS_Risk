...
validation_methods <- c("cindex", "dunn", "gamma", "gplus", "mcclain", "ptbiserial", "silhouette", "tau")
...
for (distance in distance_types) {
  ...
  for (method in validation_methods) {
    ...
    cat("Running validation for method:", method, "and distance:", distance, "\n")
...
cat("RDS file containing validation/optimization indices written successfully\n")
...
cat("csv file containing run times for each validation index written successfully\n")
