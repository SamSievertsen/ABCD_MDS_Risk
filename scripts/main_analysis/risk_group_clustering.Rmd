...
write.csv(silhouette_data, "../../results/kproto_individual_silhouette_scores.csv", row.names = FALSE)
write.csv(silhouette_scores, "../../results/kproto_silhouette_means.csv", row.names = FALSE)
...
saveRDS(kproto_results, file = "../../results/kproto_clustering_results.rds")

#5.2 Silhouette score comparison data
write.csv(silhouette_scores, "../../results/kproto_silhouette_comparison.csv", row.names = FALSE)

#5.3 Elbow plot data (total within sum of squares values)
write.csv(elbow_plot_data, "../../results/kproto_elbow_plot_data.csv", row.names = FALSE)
