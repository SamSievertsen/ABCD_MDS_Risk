...
- Increased Sample Size & Diagnostic Prevalence:  
  ...
  - Aggregating Y1-3 data resulted in higher incidence rates across all diagnoses - liekly driven by BD-I diagnoses
...
- Potential Overdiagnosis Concerns:  
  ...
  - The ABCD KSADS-COMP's lack of manual clinician review may contribute to overdiagnosis, particularly for mania -> BD-I.  
...
write.csv(bipolar_suicidality_risk_analysis_data, "../../data/data_processed/bipolar_suicidality_risk_analysis_data.csv", row.names = FALSE)
