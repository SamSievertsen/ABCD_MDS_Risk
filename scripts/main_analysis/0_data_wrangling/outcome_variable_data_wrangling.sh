...
## outcome_variable_data_wrangling.sh ##
## Render the outcome wrangling Rmd ##

#SBATCH --job-name=outcome_data_wrangle
...
# Set script location
SCRIPT="${REPO}/scripts/main_analysis/0_data_wrangling/outcome_variable_data_wrangling.Rmd"
...
apptainer exec \
  ...
  Rscript - <<'EOF'
rmarkdown::render(
  input = "outcome_variable_data_wrangling.Rmd",
  quiet = FALSE
)
