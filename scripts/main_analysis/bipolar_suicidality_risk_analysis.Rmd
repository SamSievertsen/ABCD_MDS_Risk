...
kable(full_cluster_counts, label = "N in Each Cluster at Baseline", col.names = c("Cluster", "N"))

#1.52 4Y followup N clusters present
kable(followup_status_table, label = "Data Present in Each Cluster at Followup")
...
## Potential inclusion of additional outcome datapoints
