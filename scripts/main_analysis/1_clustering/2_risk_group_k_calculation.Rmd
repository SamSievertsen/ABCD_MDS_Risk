...
- Among the `r nrow(summary_tbl)` validation indices we were able to run, `r sum(summary_tbl$k_opt == consensus_k)` (`r paste(summary_tbl$label[summary_tbl$k_opt == consensus_k], collapse = ", ")`) vote for *k* = `r print(consensus_k)`  
...
- Taken together, these results indicate that *k* = `r print(consensus_k)` likely balances cohesion and separation most consistently in our risk variable data; pending contextualization of these results post-completion of this script
