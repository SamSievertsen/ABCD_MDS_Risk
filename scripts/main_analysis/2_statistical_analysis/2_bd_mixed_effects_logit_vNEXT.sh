...
## 2_bd_mixed_effects_logit_vNEXT.sh ##
## render 2_bd_mixed_effects_logit_vNEXT.Rmd on ARC ##

#SBATCH --job-name=bd_mixed_logit_vNEXT
...
RMD_FILE="2_bd_mixed_effects_logit_vNEXT.Rmd"
